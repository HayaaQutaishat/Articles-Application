...
Additionally, I used javascript to the frontend and the logic, also to make this web application pages more interactive. Also, I used the Fetch API to allow to asynchronously request for a resource.
